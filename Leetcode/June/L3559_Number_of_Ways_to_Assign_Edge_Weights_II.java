...
public class L3559_Number_of_Ways_to_Assign_Edge_Weights_II {
    public static void main(String[] args) {
        int[][] edges = {{1,2}, {1,3}, {3,4}, {3,5}};
        int[][] queries = {{1,4}, {3,4}, {2,5}};
        int[] ans = assignEdgeWeights(edges, queries);
    ...
    static int[][] lift; // Binary lifting table: lift[i][j] = 2^j-th ancestor of node i
