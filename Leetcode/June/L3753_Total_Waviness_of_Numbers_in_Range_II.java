...
public class L3753_Total_Waviness_of_Numbers_in_Range_II {
    public static void main(String[] args) {
        L3753_Total_Waviness_of_Numbers_in_Range_II l = new L3753_Total_Waviness_of_Numbers_in_Range_II();
        long num1 = 120, num2 = 129;
        System.out.println(l.totalWaviness(num1, num2));
    }
