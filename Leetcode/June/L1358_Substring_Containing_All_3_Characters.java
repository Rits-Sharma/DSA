...
public class L1358_Substring_Containing_All_3_Characters {
    public static void main(String[] args) {
        String s = "aabcabc";
        System.out.println(noOfSubstrings2(s));
    }
    ...
    public static int noOfSubstrings(String s) {
        ...
        for (int i = 0; i < chars.length; i++) {
            ...
            for (int j = i; j < chars.length; j++) {
                if (chars[j] == 'a') flagA = true;
                if (chars[j] == 'b') flagB = true;
                if (chars[j] == 'c') flagC = true;

                if (flagA && flagB && flagC) ans++;
            }
        }
        return ans;
    }
    ...
    // Time: O(n), Space: O(1)
    // ===================================================
    public static int noOfSubstrings2(String s) {
